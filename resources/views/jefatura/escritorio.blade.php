              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="{{ url('jefat/formActualizarContrasena')}}" class="btn btn-default btn-flat">Cambiar contraseña</a>
                    </div>
                    <div class="pull-right">
                      <a href="{{ url('jefat/formActualizarDatos')}}" class="btn btn-default btn-flat">Cambiar datos</a>
                    </div>
                  </li>
