                      ...
                      <tr>
                        ...
                        <td>
                            <div class="row" style="margin: 0;">
                                <a class="col-md-2 btn btn-info" target="_black" href="{{ url('inspec/verArchivo') }}/{{$a->ruta_archivo}}">Ver</a>
                                <form class="col-md-4" action="{{ url('inspec/descargarArchivo') }}" method="get" id="form_{{ $a->id }}">
